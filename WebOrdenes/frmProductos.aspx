<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmProductos.aspx.cs" Inherits="WebOrdenes.frmProductos" %>
        ...
        <table class="nav-justified">
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="12pt" Text="Administración - Productos" style="text-decoration: underline"></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 48px">&nbsp;</td>
                <td class="text-left">
                    <asp:TextBox ID="txtDescripcion" runat="server" Width="318px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 4px">&nbsp;</td>
            ...
            <tr>
                ...
                <td style="width: 48px">&nbsp;</td>
                <td class="text-left">
                    <asp:TextBox ID="txtPrecio" runat="server" Width="150px" onKeyPress="return numerosDecimales(event, this)">0</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 4px">&nbsp;</td>
            ...
            <tr>
                ...
                <td style="width: 48px">&nbsp;</td>
                <td>
                    <asp:GridView ID="grwProductos" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id_producto" ForeColor="#333333" GridLines="None" Height="35px" Width="652px">
